package com.uppermoon.touristaapp.ui.customview
...
class MyEditTextEmail: AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        warningButtonImage = ContextCompat.getDrawable(context, R.drawable.icon_error) as Drawable
        ...
        if (compoundDrawables[2] != null) {
            when (event.action) {
                MotionEvent.ACTION_UP -> {
                    warningButtonImage =
                        ContextCompat.getDrawable(context, R.drawable.icon_error) as Drawable
